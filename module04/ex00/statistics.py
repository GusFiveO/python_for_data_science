...
def median(array):
	...
	if len_array % 2 == 0:
		tot = sorted_array[int(len_array / 2)] + sorted_array[int(len_array / 2) - 1]
...
def var(array):
	...
	print(f"std: {square_diff_sum / (len_array)}")

def execute_method(input_value, array):
    func = jumping_table.get(input_value)
    if func:
        func(array)
